...
<body> 
        ...
        // $id = "asdf"; //임의로 설정
            echo "ID: $UserID";
            $sql = "UPDATE USERTABLE SET USERTHEMA='$Thema', USERPURPOSE='$Purpose', USERNUMBERPEOPLE='$NumberPeople', USERFAMILYTYPE='$FamilyType', USERANIMAL='$Animal' WHERE USERID = '$UserID'";
            echo $sql;
